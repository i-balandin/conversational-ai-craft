...
I'm not claiming the first half is new; it's standard advice by now. The part I think deserves more attention is the silent pass from stage checks on unfinished conversations, and the not-applicable fix. If you've seen it described somewhere, I'd genuinely like to know.
